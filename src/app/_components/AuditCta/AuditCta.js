  ...
  return (
    <section className={styles.ctaSection} id="contact">
      <div>
        ...
        <h2>Need regular pool care or help getting the water back under control?</h2>
        <p>
          Call 904 Pools for residential pool cleaning, chemical care, commercial
          service, filter cleaning, stain removal, and algae treatment around Jacksonville.
        </p>
      </div>
